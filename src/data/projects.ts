...
export const projects: Project[] = [
  // Web/Mobile Development Projects
  {
    ...
    description: "An AI-powered study companion that helps users organize their study materials, generate quizzes, and track learning progress. Features personalized study plans, flashcards, and AI-generated summaries.",
    project_url: "https://www.wisker.app/",
    image_url: "/images/wisker_landingpage.png",
    created_at: "2025-07-13",
    technologies: ["Next.js", "TailwindCSS", "PostGresSQL", "Supabase", "Prisma", "Gemini API"],
    order: 1
  },
  {
    id: 2,
