    ...
    <main className="h-screen flex flex-col relative bg-black overflow-y-scroll snap-y snap-mandatory">
      ...
      <div className="relative z-10">
        ...
        <footer className="fixed bottom-0 left-0 right-0 z-50 backdrop-blur-md bg-black/20 border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between h-16 gap-2 sm:gap-0">
              <a href="mailto:work.rparagoso@gmail.com" className="text-sm sm:text-base text-white hover:text-indigo-400 transition-colors">work.rparagoso@gmail.com</a>
              <span className="text-sm text-white/60">© {new Date().getFullYear()} Ron Paragoso. All rights reserved.</span>
              <a href="tel:+639159427791" className="text-sm sm:text-base text-white hover:text-indigo-400 transition-colors">+639159427791</a>
            </div>
          </div>
        </footer>
      </div>
