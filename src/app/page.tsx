      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
            I am a software engineer working with different frameworks.
          </p>
          <div className="flex justify-center gap-4">
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-lg border border-gray-700 hover:border-gray-600 bg-gray-800 text-gray-200 font-medium transition-colors"
            >
