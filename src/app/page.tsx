      ...
      <div className="mt-8 relative z-10">
        ...
        <div className="p-8 max-w-7xl mx-auto w-full flex gap-4">
          <a
            ...
            className="inline-flex items-center px-4 py-2 border border-gray-600 rounded-md shadow-sm text-sm font-medium text-white bg-black/40 hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
