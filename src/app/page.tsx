    ...
    <main className="h-screen flex flex-col relative bg-black overflow-y-scroll snap-y snap-mandatory">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/20 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex items-center justify-between h-16">
            <div className="text-xl font-semibold text-white">RP</div>
            <div className="flex gap-8">
              <a href="#home" className="text-white hover:text-indigo-400 transition-colors">Home</a>
              <a href="#projects" className="text-white hover:text-indigo-400 transition-colors">Projects</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="relative z-10">
        ...
        <section id="home" className="h-screen flex items-center justify-center snap-start">
          <div className="max-w-7xl mx-auto w-full px-8">
            <div className="space-y-8">
              <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent leading-tight">
        ...
        <section id="projects" className="h-screen flex items-center justify-center snap-start">
          <div className="max-w-7xl mx-auto w-full px-8">
            <h2 className="text-4xl md:text-5xl font-semibold text-white mb-8">Projects</h2>
